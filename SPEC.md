...
- for actual software agents, the primary public entrypoint is `https://queuekeeper.xyz/skill.md`
- a minimal handoff command is `curl -s https://queuekeeper.xyz/skill.md`
